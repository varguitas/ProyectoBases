...
GO
CREATE PROCEDURE add_multimedia (@NOMBRE varchar(100), @DESCRIPCION varchar(100), @FORMATO varchar(100), @TAMANO int, @TIPO_MULTIMEDIA char(1),@RUTA varchar(100)) AS
BEGIN
	INSERT INTO MULTIMEDIA VALUES(@NOMBRE,@DESCRIPCION,@FORMATO,@TAMANO,@TIPO_MULTIMEDIA,(SELECT ARCHIVO FROM OPENROWSET (BULK @RUTA, SINGLE_BLOB)) AS X)
END
